var WebSquareLang = {
    ...
    Grid_column_hide: "숨기기",
    Grid_column_showAll: "숨기기 해제",
    Grid_column_fix: "틀고정",
    Grid_column_unfix: "틀고정 취소",
    Grid_column_adjustWidth: "선택 컬럼 폭 조정",
    Grid_column_adjustAuto: "전체 컬럼 폭 조정",
    Grid_column_adjustAuto_none: "폭 조정 해제",
    Grid_fold_all: "그룹핑 접기",
    Grid_unfold_all: "그룹핑 펼치기",
    Grid_ungroup_all: "그룹핑 전체 해제",
    Grid_ungroup: "그룹핑 해제",
    Grid_group: "그룹핑",
