package kw.ecs.me.elyrseltengmsrins.service;
...
/**
 * ElyrsEltengMsrinsService 서비스 인터페이스
 * 
 * @ClassName ElyrsEltengMsrinsService.java
...
public interface ElyrsEltengMsrinsService {
	/**
	...
	/**
	 * 관리/폐기의 발전 전력량계 관리 목록을 관리/폐기의 발전 전력량계 관리 목록을 저장/수정/삭제한다.한다.
	 * 
	 * @param @ElyrsEltengMsrinsVo
